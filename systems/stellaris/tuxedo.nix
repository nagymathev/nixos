...
boot.kernelPackages = pkgs.linuxKernel.packages.linux_zen.extend (final: prev: {
	tuxedo-drivers = inputs.tuxedo.legacyPackages.x86_64-linux.linuxKernel.packages.linux_zen.tuxedo-drivers;
});
